...
Route::middleware('cors')->group(function () {
    Route::post('authenticate', 'ApiV2Controller@index')->name('postAuthenticateUser');
    Route::post('/signup', 'ApiV2Controller@signup')->name('postsignup');
    Route::post('/signout', 'ApiV2Controller@signOut')->name('signOut');
    Route::post('/refresh-auth-token', 'ApiV2Controller@refreshAuthToken')->name('refreshAuthToken');
