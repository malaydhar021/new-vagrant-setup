(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/platform'), require('@angular/cdk/scrolling'), require('@angular/cdk/layout'), require('@angular/core'), require('@angular/common'), require('@angular/cdk/bidi'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-scrollbar', ['exports', '@angular/cdk/platform', '@angular/cdk/scrolling', '@angular/cdk/layout', '@angular/core', '@angular/common', '@angular/cdk/bidi', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global['ngx-scrollbar'] = {}),global.ng.cdk.platform,global.ng.cdk.scrolling,global.ng.cdk.layout,global.ng.core,global.ng.common,global.ng.cdk.bidi,global.rxjs,global.rxjs.operators));
}(this, (function (exports,platform,scrolling,layout,core,common,bidi,rxjs,operators) { 'use strict';
                ...
                Promise.resolve().then(function () {
                    if (!_this.disabled) {
                        if (_this.disableOnBreakpoints) {
                            ...
                            _this._breakpointSub$ = _this._breakpointObserver.observe(_this.disableOnBreakpoints).pipe(operators.tap(function (result) { return result.matches ? _this.disable() : _this.enable(); })).subscribe();
                        }
                        else {
                            _this.enable();
                        }
                    ...
                    _this._updateObserverSub$ = _this.updateObserver.pipe(operators.throttleTime(200), operators.tap(function () { return _this._changeDetectorRef.markForCheck(); })).subscribe();
                });
            };
        /**
         * @return {?}
         ...
         */
            function () {
                ...
                if (this.view) {
                    ...
                    if (this.autoUpdate && common.isPlatformBrowser(this._platform)) {
    ...
    ***************************************************************************** */
         ...
         */
            function () {
                ...
                if (common.isPlatformBrowser(this._platform)) {
                    ...
                    this._updateObserver$ = this._parent.updateObserver.pipe(operators.throttleTime(200), operators.tap(function () { return _this.updateScrollbar(); }), 
    ...
    var NgScrollbarY = /** @class */ (function (_super) {
         ...
         */
            function () {
                ...
                /** @type {?} */
                var mouseUp$ = rxjs.fromEvent(this._document, 'mouseup').pipe(operators.tap(function () { return _this._document.onselectstart = null; }));
                ...
                }), operators.pluck('offsetY'), operators.mergeMap(function (mouseDownOffset) {
                    return mouseMove$.pipe(operators.takeUntil(mouseUp$), operators.pluck('clientY'), operators.tap(function (mouseMoveClient) {
                        /** @type {?} */
        ...
        /** @nocollapse */
        NgScrollbarY.ctorParameters = function () {
            return [
    ...
    var NgScrollbarX = /** @class */ (function (_super) {
         ...
         */
            function () {
                ...
                }), operators.pluck('offsetX'), operators.mergeMap(function (mouseDownOffset) {
                    return mouseMove$.pipe(operators.takeUntil(mouseUp$), operators.pluck('clientX'), operators.tap(function (mouseMoveClient) {
                        /** @type {?} */
        ...
        /** @nocollapse */
        NgScrollbarX.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [common.DOCUMENT,] }] },
                { type: NgScrollbar, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return NgScrollbar; }),] }] },
                { type: Object, decorators: [{ type: core.Inject, args: [core.PLATFORM_ID,] }] },
    ...
    exports.SmoothScroll = SmoothScroll;
    exports.ɵb = NgScrollbarThumb;
    exports.ɵc = NgScrollbarX;
    exports.ɵa = NgScrollbarY;
