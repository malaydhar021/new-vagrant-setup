<template>
    <div class="exitPopup theme2 prevwPage">
      <div class="overlay nsm-overlay-open" :style="{background: data.popup_backdrop_color}">
        <div class="nsm-dialog nsm-dialog-animation-fade nsm-dialog-open">
          <div class="nsm-content">
            ...
            <button class="nsm-dialog-btn-close" type="button" :style="{background: data.header_background_color}" @click="popupClosed">
            </button>
          </div>
        </div>
      </div>
...
export default {
    ...
    name: "homecomingpopup",
    
    data: function () {
        return {
            componentName: 'Im homecoming popup component',
            stickyReviews: {},
            exitPopData: {},
            showWidget: false,
            fromExitPopup: true,
